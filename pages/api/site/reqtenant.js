        ...
        if(siteData.status === '0'){
            ...
            if(tenantData){
                ...
                if(histData){
                    ...
                    var data = await Sites.findByIdAndUpdate(histData.site_id,{$set:{tenant:histData.tenant_id,status:"1"},$push:{history: histData._id}})
                    if(data){
                    ...
                    return sendError(res,"error in saving history data",constants.SERVER_ERROR)
                }
            ...
            return sendError(res,"can't send request as status is not 0",constants.SERVER_ERROR)
        }
    }
    else{
