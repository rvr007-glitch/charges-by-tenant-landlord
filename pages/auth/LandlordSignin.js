                    ...
                    <div className="container pr_container prj">
                        ...
                        <div className="signin-content">
                            <div className="signin-image">
                                <figure><Image src={Landlord} height={350} width={530} alt="sing up image" /></figure>
                            </div>
                            <div className="signin-form">
                                <h2 className="form-title pr_form-title">Tenant Sign In</h2>
                                <form method="POST" className="register-form" id="login-form">
                                    <div className="form-group pr_form-group">
                                        <label className='pr_label' for="your_name"><i className="fas fa-user"></i></label>
                                        <input className="pa_input" type="text" name="your_name" id="your_name" placeholder="Your Name" />
                                    </div>
                                    <div className="form-group pr_form-group">
                                        <label className='pr_label' for="your_pass"><i className="fas fa-lock"></i></label>
                                    ...
                                    <div className="custom-control custom-checkbox pt-5">
                                        ...
                                        <label className="custom-control-label p_remember" for="customCheck1"><span className="disable">Remember Me</span></label>
                                    </div>
                                    <div>
