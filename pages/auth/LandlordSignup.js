                            ...
                            <div className="signup-form">
                                ...
                                <form method="POST" className="register-form" id="register-form">
                                    <div className="form-group pr_form-group">
                                        <label className='pr_label' for="name"><i className="fas fa-user"></i></label>
                                        <input className="pa_input" type="text" name="name" id="name" placeholder="Your Name" />
                                    </div>
                                    <div className="form-group pr_form-group">
                                        <label className='pr_label' for="email"><i className="fas fa-envelope"></i></label>
                                        <input className="pa_input" type="text" name="email" id="email" placeholder="Your Email" />
                                    </div>
                                    <div className="form-group pr_form-group">
                                        <label className='pr_label' for="contact"><i className="fas fa-phone-square-alt"></i></label>
                                        <input className="pa_input" type="text" name="contact" id="contact" placeholder="Your Contact" />
                                    </div>
                                    <div className="form-group pr_form-group">
                                        <label className='pr_label' for="pass"><i className="fas fa-lock"></i></label>
                                        <input className="pa_input" type="password" name="pass" id="pass" placeholder="Password" />
                                    </div>
                                    <div className="form-group pr_form-group">
                                        <label className='pr_label' for="re-pass"><i className="fas fa-lock"></i></label>
